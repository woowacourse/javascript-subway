...
- [ ] 사용자는 처음 접속하면 메인 페이지를 볼 수 있다.
  - [ ] 로그인을 안한 사람은 로그인 페이지를 보여준다.
- [ ] 사용자는 회원 가입을 할 수 있다. (이메일, 이름, 비밀번호)
  - [ ] 이메일은 형식에 맞추어 쓴다.
  - [ ] 이메일 중복체크를 한다.
  - [ ] 이름 글자수 제한을 20글자로 한다.
  - [ ] 비밀번호는 숫자와 영문 조합으로 한다.
  - [ ] 비밀번호 글자 수는 9~ 16글자 사이이다.
  - [ ] 비밀번호 확인을 한다.
- [ ] 사용자는 로그인을 할 수 있다.
  - [ ] 로그인에 실패하면 alert로 알려준다.
- [ ] 로그인하면 메인 페이지를 보여준다.
  - [ ] 각 메뉴를 선택하여 이동할 수 있다.
  - [ ] 로그인 버튼 → 로그아웃 버튼
- [ ] 사용자는 로그아웃을 할 수 있다.
  - [ ] 로그아웃 버튼 → 로그인
  - [ ] 로그아웃을 하면 메인 페이지를 보여준다.
