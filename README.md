...
- [x] 지하철역의 이름을 수정할 수 있다.
  ...
  - [x] 기존 역 이름과 현재 역 이름이 같은 경우 수정하지 않는다.
- [x] 지하철역을 삭제할 수 있다.
...
- [x] 지하철 노선을 등록할 수 있다.
  ...
  - [x] 노선의 시간과 거리는 양수만 가능하다.
  - [x] 노선의 상행역과 하행역은 다른 역이어야 한다.
- [x] 지하철 노선을 수정 수 있다.
...
- [x] 지하철 노선에 구간을 추가, 삭제할 수 있다.
  ...
  - [x] 구간 삭제 기능을 만든다.
  - [x] 상행역과 하행역이 같은 구간은 추가할 수 없다.
  - [x] 역 사이에 시간 또는 거리 조건에 맞는 역만 구간에 추가할 수 있다.
  - [x] 구간의 시간과 거리는 양수만 가능하다.
