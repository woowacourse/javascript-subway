export const lineModify = `
  ...
  <form id="line-modify-form">
    ...
    <div class="d-flex justify-end mt-3">
      <button id="line-modify-button" type="submit" name="submit" class="input-submit bg-cyan-300">확인</button>
    </div>
  </form>
  </div>
`;
