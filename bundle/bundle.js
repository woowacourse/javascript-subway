...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _constants_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constants.js */ \"./src/js/constants.js\");\n/* harmony import */ var _utils_querySelector_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/querySelector.js */ \"./src/js/utils/querySelector.js\");\n/* harmony import */ var _components_HomeComponent_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/HomeComponent.js */ \"./src/js/components/HomeComponent.js\");\n/* harmony import */ var _components_LoginComponent_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/LoginComponent.js */ \"./src/js/components/LoginComponent.js\");\n/* harmony import */ var _components_SignupComponent_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/SignupComponent.js */ \"./src/js/components/SignupComponent.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n\n\n\n\nvar router = {\n  routes: {\n    '/': new _components_HomeComponent_js__WEBPACK_IMPORTED_MODULE_2__.default({}),\n    '/pages/login.html': new _components_LoginComponent_js__WEBPACK_IMPORTED_MODULE_3__.default({}),\n    '/pages/signup.html': new _components_SignupComponent_js__WEBPACK_IMPORTED_MODULE_4__.default({})\n  },\n  render: function () {\n    var _render = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(path) {\n      return regeneratorRuntime.wrap(function _callee$(_context) {\n        while (1) {\n          switch (_context.prev = _context.next) {\n            case 0:\n              router.routes[path].render();\n              router.routes[path].initEvent();\n\n            case 2:\n            case \"end\":\n              return _context.stop();\n          }\n        }\n      }, _callee);\n    }));\n\n    function render(_x) {\n      return _render.apply(this, arguments);\n    }\n\n    return render;\n  }(),\n  init: function init() {\n    history.replaceState({\n      path: '/'\n    }, null, '/');\n    window.addEventListener('popstate', function (e) {\n      router.render(e.state.path);\n    });\n    (0,_utils_querySelector_js__WEBPACK_IMPORTED_MODULE_1__.default)('header').addEventListener('click', function (event) {\n      event.preventDefault();\n      var anchor = event.target.closest(\".\".concat(_constants_js__WEBPACK_IMPORTED_MODULE_0__.CLASS_SELECTOR.ANCHOR));\n      if (!anchor) return;\n      var path = anchor.getAttribute('href');\n      history.pushState({\n        path: path\n      }, null, path);\n      router.render(path);\n    });\n  }\n};\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (router);\n\n//# sourceURL=webpack:///./src/js/router.js?");
