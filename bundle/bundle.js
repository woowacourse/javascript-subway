...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _css_constants_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../css/constants.js */ \"./src/css/constants.js\");\n/* harmony import */ var _utils_querySelector_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/querySelector.js */ \"./src/js/utils/querySelector.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n\nvar router = {\n  routes: {\n    '/': '/data/home.json',\n    '/pages/stations.html': '/data/station.json'\n  },\n  render: function () {\n    var _render = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(path) {\n      var url, res, _yield$res$json, contents;\n\n      return regeneratorRuntime.wrap(function _callee$(_context) {\n        while (1) {\n          switch (_context.prev = _context.next) {\n            case 0:\n              url = router.routes[path];\n              _context.next = 3;\n              return fetch(url);\n\n            case 3:\n              res = _context.sent;\n              _context.next = 6;\n              return res.json();\n\n            case 6:\n              _yield$res$json = _context.sent;\n              contents = _yield$res$json.contents;\n              (0,_utils_querySelector_js__WEBPACK_IMPORTED_MODULE_1__.default)(\"#\".concat(_css_constants_js__WEBPACK_IMPORTED_MODULE_0__.ID_SELECTOR.MAIN)).innerHTML = contents;\n\n            case 9:\n            case \"end\":\n              return _context.stop();\n          }\n        }\n      }, _callee);\n    }));\n\n    function render(_x) {\n      return _render.apply(this, arguments);\n    }\n\n    return render;\n  }(),\n  init: function init() {\n    history.replaceState({\n      path: '/'\n    }, null, '/');\n    window.addEventListener('popstate', function (e) {\n      router.render(e.state.path);\n    });\n    (0,_utils_querySelector_js__WEBPACK_IMPORTED_MODULE_1__.default)(\"#\".concat(_css_constants_js__WEBPACK_IMPORTED_MODULE_0__.ID_SELECTOR.NAVIGATION)).addEventListener('click', function (e) {\n      e.preventDefault();\n      var anchor = e.target.closest(\".\".concat(_css_constants_js__WEBPACK_IMPORTED_MODULE_0__.CLASS_SELECTOR.NAVIGATION_BUTTON));\n      if (!anchor) return;\n      var path = anchor.getAttribute('href');\n      history.pushState({\n        path: path\n      }, null, path);\n      router.render(path);\n    });\n  }\n};\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (router);\n\n//# sourceURL=webpack:///./src/js/router.js?");
